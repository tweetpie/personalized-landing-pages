...
class SBertClassifier(torch.nn.Module):
    """
    Sentence-BERT model for text classification tasks (e.g., sentiment analysis, topic classification, etc.)
    ...
    def __init__(self, dropout_rate=0.3, n_outputs=2):
        ...
        self.pretrained_model = AutoModel.from_pretrained('sentence-transformers/bert-base-nli-mean-tokens')
